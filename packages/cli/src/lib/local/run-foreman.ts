...
program
  ...
  .action(function (this: any, args) {
    ...
    startProxies(reqs, proc, this, emitter, program.port || envs.PORT || process.env.PORT || 5000)
...
program
  ...
  .action(function (this: any, procArgs) {
    ...
    const baseport = Number.parseInt(program.port || envs.PORT || process.env.PORT || 5000)
    let baseport_i = 0
    let baseport_j = 0
    let envl = []
