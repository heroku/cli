...
export interface Space {
  ...
  data_cidr: string;
  /**
   * Generation of the Heroku platform for this space
   */
  readonly generation: SpaceGeneration;
}
/**
 *
...
export interface DynoSize {
  /**
   * CPU architecture of this dyno size
   *
   * @example "arm64"
   */
  ...
  /**
   * whether compute resources are dedicated or shared
   */
 ...
 */
export interface OciImageBuildpack {
  /**
...
export interface OciImageCreatePayload {
   ...
   * buildpacks of the OCI image
   */
  buildpacks?: OciImageCreatePayloadBuildpack[];
}
/**
 *
 * set of executables that inspects app source code and creates a plan to build and run your image
 */
export interface OciImageCreatePayloadBuildpack {
  /**
   * identifier of the buildpack
   *
   * @example "heroku/ruby"
...
export interface PipelineGeneration {
  ...
  readonly name?: string;
  /**
   * when the generation was updated
   *
   * @example "2024-12-01T12:00:00Z"
   */
  readonly updated_at?: string;
 ...
 * Generation of the Heroku platform for this space
 */
export interface SpaceGeneration {
  /**
   * unique identifier of the generation of the Heroku platform for this space
   *
   * @example "01234567-89ab-cdef-0123-456789abcdef"
   */
  readonly id?: string;
  /**
   * unique name of the generation of the Heroku platform for this space
   *
   * @example "cedar"
   */
  readonly name?: string;
