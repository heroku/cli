...
describe('buildpacks:remove', function () {
  ...
  describe('-i INDEX', function () {
    it('# with one buildpack successfully removes index', async () => {
...
`)
    ...
    it('# with one buildpack successfully removes index with language warn', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
      ...
      const {stdout, stderr} = await runCommand(['buildpacks:remove', '-i', '1', '-a', 'example'])
...
`)
    ...
    it('# with one buildpack successfully removes index with buildpack warn', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/heroku/heroku-buildpack-ruby',
      ])
...
`)
    ...
    it('# with two buildpacks successfully removes index - java', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
...
`)
    ...
    it('# with two buildpacks successfully removes index - ruby', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/heroku/heroku-buildpack-java',
        'https://github.com/heroku/heroku-buildpack-ruby',
...
`)
    ...
    it('# with three buildpacks successfully removes index', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/heroku/heroku-buildpack-java',
...
`)
    ...
    it('# with no buildpacks reports an error removing index', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api)
    ...
    it('# returns an error when the index > 1 and the size is one', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
    ...
    it('# returns an error when the index > size and the size > one', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/foo/foo',
  ...
  describe('URL', function () {
    it('# with one buildpack successfully removes url', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/heroku/heroku-buildpack-ruby',
      ])
...
`)
    ...
    it('# with two buildpacks successfully removes url', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/heroku/heroku-buildpack-java',
        'https://github.com/heroku/heroku-buildpack-ruby',
      ...
      const {stdout, stderr} = await runCommand(['buildpacks:remove', 'https://github.com/heroku/heroku-buildpack-ruby', '-a', 'example'])
...
`)
    ...
    it('# remove by name should work', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
      ...
      const {stdout, stderr} = await runCommand(['buildpacks:remove', 'heroku/ruby', '-a', 'example'])
...
`)
    ...
    it('# with no buildpacks reports an error removing buildpack_url', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api)
    ...
    it('# returns an error when the url is not found', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/foo/foo',
      ])
    ...
    it('# with three buildpacks successfully removes url', async () => {
      const api = nock('https://api.heroku.com')
      Stubber.get(api, [
        'https://github.com/heroku/heroku-buildpack-java',
        'https://github.com/heroku/heroku-buildpack-nodejs',
...
`)
  ...
  describe('-i INDEX URL', function () {
    it('# returns an error message when i and url are specified', async () => {
    ...
    it('# returns an error message neither i or url are specified', async () => {
