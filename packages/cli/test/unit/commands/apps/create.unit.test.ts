...
//     mock.done()
//     expect(stderr).to.equal('Creating app... done, foobar\n')
//     expect(stdout).to.equal('https://foobar.com | https://git.heroku.com/foobar.git\n')
//   })
// })
//
...
//     mock.done()
//     expect(stderr).to.equal('Creating app in space my-space-name... done, foobar\n')
//     expect(stdout).to.equal('https://foobar.com | https://git.heroku.com/foobar.git\n')
//   })
// })
//
...
//
//     expect(stderr).to.equal('Creating app... done, foobar\n')
//     expect(JSON.parse(stdout), 'to satisfy', json)
//   })
// })
//
