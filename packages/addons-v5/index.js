...
exports.topic = {
  ...
  (such as \`heroku-postgresql:heroku-postgresql:standard-0\`).
  ...
  is \`postgresql-deep-6913\` with a default attachment alias of \`DATABASE\`:
    ...
    Creating postgresql-deep-6913... done, (heroku-postgresql:standard-0)
    ...
    Add-on                                     Plan                          Price
    ─────────────────────────────────────────  ────────────────────────────  ──────────
    heroku-postgresql (postgresql-deep-6913)   heroku-postgresql:standard-0  $50/month
    └─ as DATABASE
  ...
  both these identifiers:
    ...
    Creating main-db... done, ($50/month)
    ...
    Add-on                                     Plan                          Price
    ─────────────────────────────────────────  ────────────────────────────  ──────────
    heroku-postgresql (main-db)                heroku-postgresql:standard-0  $50/month
    └─ as PRIMARY_DB
