...
@heroku-cli/plugin-autocomplete/1.0.4 darwin-x64 node-v10.1.0
$ heroku --help [COMMAND]
USAGE
  $ heroku COMMAND
...
...
_See code: [src/commands/autocomplete.ts](https://github.com/heroku/heroku-cli-autocomplete/blob/v1.0.4/src/commands/autocomplete.ts)_
<!-- commandsstop -->
