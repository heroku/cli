...
_See code: [lib/commands/local/run.js](https://github.com/heroku/cli/blob/v7.19.0/packages/local-v5/lib/commands/local/run.js)_
...
_See code: [lib/commands/local/version.js](https://github.com/heroku/cli/blob/v7.19.0/packages/local-v5/lib/commands/local/version.js)_
<!-- commandsstop -->
