...
@heroku-cli/plugin-status/5.0.8 (darwin-x64) node-v9.5.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/heroku-cli-status/blob/v5.0.8/src/commands/status.ts)_
<!-- commandsstop -->
