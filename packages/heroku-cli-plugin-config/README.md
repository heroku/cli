...
@heroku-cli/plugin-config/1.0.4 linux-x64 node-v10.0.0
$ heroku --help [COMMAND]
USAGE
  $ heroku COMMAND
...
...
_See code: [src/commands/config/edit.ts](https://github.com/heroku/heroku-cli-plugin-config/blob/v1.0.4/src/commands/config/edit.ts)_
<!-- commandsstop -->
