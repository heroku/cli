...
async function run(context, heroku) {
  ...
  cli.warn(`Follow https://devcenter.heroku.com/articles/data-maintenance-cli-commands#installation to install the plugin and run ${cli.color.cmd('data:maintenances:window:update')} to change the database maintenance window.`)
