...
@heroku-cli/plugin-status/7.16.0 darwin-x64 node-v8.11.4
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.16.0/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
