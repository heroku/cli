...
@heroku-cli/plugin-status/7.66.3 darwin-x64 node-v16.0.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.66.3/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
