...
@heroku-cli/plugin-status/7.18.6 darwin-x64 node-v11.1.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.18.6/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
