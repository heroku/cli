...
@heroku-cli/plugin-status/7.18.0 darwin-x64 node-v10.12.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.18.0/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
