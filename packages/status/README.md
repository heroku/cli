...
@heroku-cli/plugin-status/7.12.4 darwin-x64 node-v10.9.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.12.4/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
