...
@heroku-cli/plugin-status/7.38.0 darwin-x64 node-v10.18.1
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.38.0/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
