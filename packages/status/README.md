...
@heroku-cli/plugin-status/7.1.0 darwin-x64 node-v10.4.1
...
_See code: [src/commands/status.ts](https://github.com/heroku/heroku-cli-status/blob/v7.1.0/src/commands/status.ts)_
<!-- commandsstop -->
