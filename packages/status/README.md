...
@heroku-cli/plugin-status/7.53.0 darwin-x64 node-v12.14.1
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.53.0/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
