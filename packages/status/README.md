...
@heroku-cli/plugin-status/7.47.13 darwin-x64 node-v12.18.4
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.47.13/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
