...
@heroku-cli/plugin-status/7.16.2 darwin-x64 node-v10.11.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.16.2/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
