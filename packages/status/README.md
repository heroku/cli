...
@heroku-cli/plugin-status/7.5.1 darwin-x64 node-v10.5.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.5.1/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
