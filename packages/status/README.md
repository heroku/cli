...
@heroku-cli/plugin-status/8.0.6 darwin-arm64 node-v16.19.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v8.0.6/src/commands/status.ts)_
<!-- commandsstop -->
