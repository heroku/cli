...
@heroku-cli/plugin-status/7.4.8 darwin-x64 node-v8.11.3
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.4.8/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
