...
@heroku-cli/plugin-status/7.38.1 darwin-x64 node-v12.14.1
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.38.1/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
