...
@heroku-cli/plugin-status/7.42.8 darwin-x64 node-v12.12.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.42.8/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
