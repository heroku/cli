...
@heroku-cli/plugin-status/7.19.0 darwin-x64 node-v11.2.0
...
_See code: [src/commands/status.ts](https://github.com/heroku/cli/blob/v7.19.0/packages/status/src/commands/status.ts)_
<!-- commandsstop -->
