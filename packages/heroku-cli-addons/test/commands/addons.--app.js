        ...
        describe('sorting', function() {
            context('add-ons', function() {
                it('sorts owned add-ons first, foreign add-ons second', function() {
                    ...
                    return run('acme-inc-dwh', function() {
                        expect(cli.stdout.indexOf('dwh-db')).to.
                            be.lt(cli.stdout.indexOf('www-db'));
                    });
                });
                ...
                it('sorts add-ons of same ownership by service', function() {
                    ...
                    return run('acme-inc-www', function() {
                        expect(cli.stdout.indexOf('heroku-postgresql')).to.
                            be.lt(cli.stdout.indexOf('heroku-redis'));
                    });
                });
                ...
                it('sorts add-ons of same ownership and service by plan', function() {
                    ...
                    return run('acme-inc-dwh', function() {
                        expect(cli.stdout.indexOf('hobby-dev')).to.
                            be.lt(cli.stdout.indexOf('standard-2'));
                    });
                });
                ...
                it('sorts add-ons of same ownership and service and plan by name', function() {
                    ...
                    return run('acme-inc-dwh', function() {
                        expect(cli.stdout.indexOf('(dwh-db)')).to.
                            be.lt(cli.stdout.indexOf('(dwh-db-2)'));
                    });
                });
            });
            ...
            context('attachments', function() {
                it('sorts local attachments first', function() {
                    ...
                    return run('acme-inc-dwh', function() {
                        expect(cli.stdout.indexOf('as WWW_DB')).to.
                            be.lt(cli.stdout.indexOf('as DATABASE on acme-inc-www app'));
                    });
                });
                ...
                it('sorts local attachments by name', function() {
                    ...
                    return run('acme-inc-www', function() {
                        expect(cli.stdout.indexOf('DATABASE')).to.
                            be.lt(cli.stdout.indexOf('HEROKU_POSTGRESQL_RED'));
                    });
                });
                ...
                it('sorts foreign attachments by app', function() {
                    ...
                    return run('acme-inc-api', function() {
                        expect(cli.stdout.indexOf('as WWW_DB on acme-inc-dwh')).to.
                            be.lt(cli.stdout.indexOf('as DATABASE on acme-inc-www'));
                    });
                });
                ...
                it('sorts foreign attachments for same app by name', function() {
                    ...
                    return run('acme-inc-api', function() {
                        expect(cli.stdout.indexOf('as DATABASE on acme-inc-www')).to.
                            be.lt(cli.stdout.indexOf('as HEROKU_POSTGRESQL_RED on acme-inc-www'));
                    });
                });
            });
        });
