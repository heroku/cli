...
@heroku-cli/plugin-git/7.47.9 darwin-x64 node-v12.18.4
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v7.47.9/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v7.47.9/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
