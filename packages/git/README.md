...
@heroku-cli/plugin-git/7.22.6 darwin-x64 node-v11.11.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v7.22.6/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v7.22.6/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
