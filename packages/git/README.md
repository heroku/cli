...
@heroku-cli/plugin-git/8.1.7-beta.0 darwin-x64 node-v16.19.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v8.1.7-beta.0/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v8.1.7-beta.0/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
