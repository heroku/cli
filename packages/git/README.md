...
@heroku-cli/plugin-git/8.0.6 darwin-arm64 node-v16.19.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v8.0.6/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v8.0.6/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
