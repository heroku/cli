...
@heroku-cli/plugin-git/7.9.3 darwin-x64 node-v10.9.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v7.9.3/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v7.9.3/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
