...
@heroku-cli/plugin-git/7.5.1 darwin-x64 node-v10.5.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v7.5.1/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v7.5.1/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
