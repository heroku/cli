...
@heroku-cli/plugin-git/7.19.1 darwin-x64 node-v11.3.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v7.19.1/packages/git/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v7.19.1/packages/git/src/commands/git/remote.ts)_
<!-- commandsstop -->
