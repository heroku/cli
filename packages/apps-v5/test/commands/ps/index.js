...
describe('ps', function () {
  ...
  it('shows dyno list', function () {
    let api = nock('https://api.heroku.com:443')
      .get('/apps/myapp/dynos')
      .reply(200, [
        { command: 'npm start', size: 'Basic', name: 'web.1', type: 'web', updated_at: hourAgo, state: 'up' },
        { command: 'bash', size: 'Basic', name: 'run.1', type: 'run', updated_at: hourAgo, state: 'up' }
      ])
...
run.1 (Basic): up ${hourAgoStr} (~ 1h ago): bash
...
`
  ...
  it('does not print out for non-eco apps', function () {
    ...
    let dynos = nock('https://api.heroku.com:443')
      .get('/apps/myapp/dynos')
      .reply(200, [{ command: 'bash', size: 'Basic', name: 'run.1', type: 'run', updated_at: hourAgo, state: 'up' }])
