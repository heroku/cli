...
@heroku-cli/plugin-git/3.0.0 darwin-x64 node-v10.1.0
...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/heroku-git/blob/v3.0.0/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/heroku-git/blob/v3.0.0/src/commands/git/remote.ts)_
<!-- commandsstop -->
