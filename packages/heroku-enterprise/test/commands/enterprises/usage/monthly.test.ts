...
describe('enterprise:usage:monthly', () => {
  ...
  test
    .command(['enterprise:usage:monthly', '--start-date', '2018-09-01', '--end-date', '2018-09-28'])
  ...
  context('when getting enterprise account usage', () => {
    ...
    test
      ...
      .command(['enterprise:usage:monthly', '--enterprise-account', 'wallyworld'])
      .do(() => MockDate.reset())
    ...
    test
      ...
      .command(['enterprise:usage:monthly', '--enterprise-account', 'wallyworld', '--start-date', '2018-09', '--end-date', '2018-10'])
  ...
  context('when getting team usage', () => {
    ...
    test
      ...
      .do(() => MockDate.set('2019-02-20'))
      .command(['enterprise:usage:monthly', '--team', 'grumpy'])
      .do(() => MockDate.reset())
  ...
  test
    .stderr()
    .command(['enterprise:usage:monthly', '-e', 'suisse', '--team', 'lausanne'])
