...
describe('enterprises:usage:daily', () => {
  ...
  test
    ...
    .nock('https://api.heroku.com', (api: any) => api
      ...
      .matchHeader('Accept', 'application/json; version=3.enterprise-accounts')
    ...
    .it('lists the usage for an enterprise account', ctx => {
      expect(ctx.stdout).to.contain('Account      Team App        Date       Dyno  Addon Partner Data ')
  ...
  test
    ...
    .it('lists the usage for an enterprise team using start and end dates', ctx => {
      expect(ctx.stdout).to.contain('App               Date       Dyno  Addon Partner Data ')
      expect(ctx.stdout).to.contain('froyo-expcore     2017-01-01 1.548 19941 4457    15484 ')
      expect(ctx.stdout).to.contain('froyo-expcore-dev 2017-01-01 3.853 1075  12      1075 ')
      expect(ctx.stdout).to.contain('froyo-expcore     2017-02-01 0     19941 4457    15484 ')
      expect(ctx.stdout).to.contain('froyo-expcore-dev 2017-02-01 3.853 1075  0       1075 ')
    })
