...
describe('enterprises:usage:daily', () => {
  ...
  test
    ...
    .nock('https://api.heroku.com', (api: any) => api
      ...
      .get('/enterprise-accounts/01234567-89ab-cdef-0123-456789abcdef/usage/daily?start=2018-09-01&end=2018-09-28')
      .reply(200, enterpriseAccountUsageResponse)
    )
    .command(['enterprises:usage:daily', '-e', 'wallyworld', '--start-date', '2018-09-01', '--end-date', '2018-09-28', '--csv'])
  ...
  test
    ...
    .nock('https://api.heroku.com', (api: any) => api
      ...
      .get('/teams/98765432-10ab-cdef-3210-456789fedcba/usage/daily?start=2018-09-01&end=2018-09-28')
