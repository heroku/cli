...
describe('reviewapps:_disable', () => {
  ...
  describe('with repos api enabled', () => {
    ...
    test
      ...
      .stderr()
      .command(['reviewapps:_disable', `--pipeline=${pipeline.name}`])
    ...
    test
      ...
      .stdout()
      .stderr()
      .command(['reviewapps:_disable', `--pipeline=${pipeline.name}`, '--autodeploy'])
    ...
    test
      ...
      .stdout()
      .stderr()
      .command(['reviewapps:_disable', `--pipeline=${pipeline.name}`, '--autodestroy'])
    ...
    test
      ...
      .stdout()
      .stderr()
      .command(['reviewapps:_disable', `--pipeline=${pipeline.name}`, '--autodeploy', '--autodestroy'])
