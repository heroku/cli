export default {
  ...
  dirname: 'heroku',
  hooks: {
    command_not_found: ['./dist/hooks/command_not_found/performance_analytics'],
    init: [
      './dist/hooks/init/version',
      './dist/hooks/init/terms-of-service',
      './dist/hooks/init/performance_analytics',
    ],
    postrun: ['./dist/hooks/postrun/performance_analytics'],
    prerun: ['./dist/hooks/prerun/analytics'],
