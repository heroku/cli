...
_See code: [src/commands/spaces/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/index.ts)_
...
```
USAGE
  $ heroku spaces:create -t <value> [--cidr <value>] [--data-cidr <value>] [--generation cedar|fir] [--region
    <value>] [-s <value>]
...
_See code: [src/commands/spaces/create.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/create.ts)_
...
```
USAGE
  $ heroku spaces:destroy [--confirm <value>] [-s <value>]
...
_See code: [src/commands/spaces/destroy.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/destroy.ts)_
...
```
USAGE
  $ heroku spaces:drains:get -s <value> [--json]
...
_See code: [src/commands/spaces/drains/get.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/drains/get.ts)_
...
```
USAGE
  $ heroku spaces:drains:set URL -s <value>
...
_See code: [src/commands/spaces/drains/set.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/drains/set.ts)_
...
```
USAGE
  $ heroku spaces:info [--json] [-s <value>]
...
_See code: [src/commands/spaces/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/info.ts)_
...
```
USAGE
  $ heroku spaces:peerings [-s <value>] [--json]
...
_See code: [src/commands/spaces/peerings/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/peerings/index.ts)_
...
```
USAGE
  $ heroku spaces:peerings:accept [-p <value>] [-s <value>]
...
_See code: [src/commands/spaces/peerings/accept.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/peerings/accept.ts)_
...
```
USAGE
  $ heroku spaces:peerings:destroy -s <value> [--confirm <value>] [-p <value>]
...
_See code: [src/commands/spaces/peerings/destroy.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/peerings/destroy.ts)_
...
```
USAGE
  $ heroku spaces:peerings:info [--json] [-s <value>]
...
_See code: [src/commands/spaces/peerings/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/peerings/info.ts)_
...
_See code: [src/commands/spaces/ps.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/ps.ts)_
...
_See code: [src/commands/spaces/rename.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/rename.ts)_
...
```
USAGE
  $ heroku spaces:topology [--json] [-s <value>]
...
_See code: [src/commands/spaces/topology.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/topology.ts)_
...
_See code: [src/commands/spaces/transfer.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/transfer.ts)_
...
```
USAGE
  $ heroku spaces:trusted-ips [-s <value>] [--json]
...
_See code: [src/commands/spaces/trusted-ips/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/trusted-ips/index.ts)_
...
_See code: [src/commands/spaces/trusted-ips/add.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/trusted-ips/add.ts)_
...
_See code: [src/commands/spaces/trusted-ips/remove.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/trusted-ips/remove.ts)_
...
_See code: [src/commands/spaces/vpn/config.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/config.ts)_
...
```
USAGE
  $ heroku spaces:vpn:connect NAME -c <value> -i <value> -s <value>
...
_See code: [src/commands/spaces/vpn/connect.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/connect.ts)_
...
_See code: [src/commands/spaces/vpn/connections.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/connections.ts)_
...
_See code: [src/commands/spaces/vpn/destroy.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/destroy.ts)_
...
_See code: [src/commands/spaces/vpn/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/info.ts)_
...
_See code: [src/commands/spaces/vpn/update.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/update.ts)_
...
_See code: [src/commands/spaces/vpn/wait.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/vpn/wait.ts)_
...
```
USAGE
  $ heroku spaces:wait [-i <value>] [--json] [-s <value>] [-t <value>]
...
_See code: [src/commands/spaces/wait.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.17/packages/cli/src/commands/spaces/wait.ts)_
