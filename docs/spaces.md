...
_See code: [src/commands/spaces/index.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/index.ts)_
...
_See code: [src/commands/spaces/create.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/create.ts)_
...
_See code: [src/commands/spaces/destroy.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/destroy.ts)_
...
_See code: [src/commands/spaces/info.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/info.ts)_
...
_See code: [src/commands/spaces/peerings/index.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/peerings/index.ts)_
...
_See code: [src/commands/spaces/peerings/accept.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/peerings/accept.ts)_
...
_See code: [src/commands/spaces/peerings/destroy.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/peerings/destroy.ts)_
...
_See code: [src/commands/spaces/peerings/info.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/peerings/info.ts)_
...
_See code: [src/commands/spaces/ps.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/ps.ts)_
...
_See code: [src/commands/spaces/rename.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/rename.ts)_
...
_See code: [src/commands/spaces/topology.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/topology.ts)_
...
_See code: [src/commands/spaces/transfer.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/transfer.ts)_
...
_See code: [src/commands/spaces/trusted-ips/index.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/trusted-ips/index.ts)_
...
_See code: [src/commands/spaces/trusted-ips/add.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/trusted-ips/add.ts)_
...
```
USAGE
  $ heroku spaces:trusted-ips:remove SOURCE [--space <value>] [--confirm <value>]

FLAGS
  --confirm=<value>  set to space name to bypass confirm prompt
  --space=<value>    space to remove rule from
...
_See code: [src/commands/spaces/trusted-ips/remove.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/trusted-ips/remove.ts)_
...
_See code: [src/commands/spaces/vpn/config.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/config.ts)_
...
_See code: [src/commands/spaces/vpn/connect.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/connect.ts)_
...
_See code: [src/commands/spaces/vpn/connections.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/connections.ts)_
...
ARGUMENTS
  NAME  name of the VPN connection to destroy
...
_See code: [src/commands/spaces/vpn/destroy.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/destroy.ts)_
...
_See code: [src/commands/spaces/vpn/info.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/info.ts)_
...
_See code: [src/commands/spaces/vpn/update.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/update.ts)_
...
```
USAGE
  $ heroku spaces:vpn:wait -s <value> -n <value> [--json] [-i <value>] [-t <value>]

FLAGS
  -i, --interval=<value>  seconds to wait between poll intervals
  -n, --name=<value>      (required) name or id of the vpn connection to wait for
  -s, --space=<value>     (required) space the vpn connection belongs to
...
_See code: [src/commands/spaces/vpn/wait.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/vpn/wait.ts)_
...
_See code: [src/commands/spaces/wait.ts](https://github.com/heroku/cli/blob/v9.0.0-alpha.2/src/commands/spaces/wait.ts)_
