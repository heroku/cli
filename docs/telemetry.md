...
```
USAGE
  $ heroku telemetry [-s <value>] [--app <value>]

FLAGS
  -s, --space=<value>  filter by space name
      --app=<value>    filter by app name
...
_See code: [src/commands/telemetry/index.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.3/packages/cli/src/commands/telemetry/index.ts)_
...
_See code: [src/commands/telemetry/add.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.3/packages/cli/src/commands/telemetry/add.ts)_
...
_See code: [src/commands/telemetry/info.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.3/packages/cli/src/commands/telemetry/info.ts)_
...
FLAGS
  -a, --app=<value>    [default: heroku-vscode] name of the app to remove all drains from
...
_See code: [src/commands/telemetry/remove.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.3/packages/cli/src/commands/telemetry/remove.ts)_
...
_See code: [src/commands/telemetry/update.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.3/packages/cli/src/commands/telemetry/update.ts)_
