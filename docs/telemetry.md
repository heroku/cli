...
_See code: [src/commands/telemetry/index.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/telemetry/index.ts)_
...
_See code: [src/commands/telemetry/add.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/telemetry/add.ts)_
...
_See code: [src/commands/telemetry/info.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/telemetry/info.ts)_
...
FLAGS
  -a, --app=<value>    [default: app2-mm-test, env: HEROKU_APP] name of the app to remove all drains from
...
_See code: [src/commands/telemetry/remove.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/telemetry/remove.ts)_
...
_See code: [src/commands/telemetry/update.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/telemetry/update.ts)_
