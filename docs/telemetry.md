...
```
USAGE
  $ heroku telemetry [-a <value>] [-s <value>]
...
_See code: [src/commands/telemetry/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.16/packages/cli/src/commands/telemetry/index.ts)_
...
```
USAGE
  $ heroku telemetry:add ENDPOINT [-a <value>] [--headers <value>] [--signals <value>] [-s <value>] [--transport
    <value>]
...
_See code: [src/commands/telemetry/add.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.16/packages/cli/src/commands/telemetry/add.ts)_
...
_See code: [src/commands/telemetry/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.16/packages/cli/src/commands/telemetry/info.ts)_
...
_See code: [src/commands/telemetry/remove.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.16/packages/cli/src/commands/telemetry/remove.ts)_
...
_See code: [src/commands/telemetry/update.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.16/packages/cli/src/commands/telemetry/update.ts)_
