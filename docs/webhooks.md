...
_See code: [src/commands/webhooks/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/index.ts)_
...
```
USAGE
  $ heroku webhooks:add -i <value> -l <value> -u <value> [--prompt] [-a <value>] [-r <value>] [-s <value>] [-t
    <value>]
...
_See code: [src/commands/webhooks/add.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/add.ts)_
...
_See code: [src/commands/webhooks/deliveries/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/deliveries/index.ts)_
...
_See code: [src/commands/webhooks/deliveries/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/deliveries/info.ts)_
...
_See code: [src/commands/webhooks/events/index.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/events/index.ts)_
...
_See code: [src/commands/webhooks/events/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/events/info.ts)_
...
_See code: [src/commands/webhooks/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/info.ts)_
...
_See code: [src/commands/webhooks/remove.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/remove.ts)_
...
```
USAGE
  $ heroku webhooks:update ID -i <value> -l <value> -u <value> [--prompt] [-a <value>] [-r <value>] [-s <value>] [-t
    <value>]
...
_See code: [src/commands/webhooks/update.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.37/src/commands/webhooks/update.ts)_
