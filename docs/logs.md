...
```
USAGE
  $ heroku logs -a <value> [-d <value>] [--force-colors] [-n <value>] [-p <value>] [-r <value>] [-s
    <value>] [-t]
...
_See code: [src/commands/logs.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.15/packages/cli/src/commands/logs.ts)_
