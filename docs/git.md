...
_See code: [@heroku-cli/plugin-git](https://github.com/heroku/cli/blob/v7.19.3/packages/git/src/commands/git/clone.ts)_
...
_See code: [@heroku-cli/plugin-git](https://github.com/heroku/cli/blob/v7.19.3/packages/git/src/commands/git/remote.ts)_
