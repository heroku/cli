...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.8/packages/cli/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.8/packages/cli/src/commands/git/remote.ts)_
