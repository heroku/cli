...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v10.7.1-beta.0/packages/cli/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v10.7.1-beta.0/packages/cli/src/commands/git/remote.ts)_
