...
_See code: [src/commands/git/clone.ts](https://github.com/heroku/cli/blob/v8.3.2-beta.2/src/commands/git/clone.ts)_
...
_See code: [src/commands/git/remote.ts](https://github.com/heroku/cli/blob/v8.3.2-beta.2/src/commands/git/remote.ts)_
