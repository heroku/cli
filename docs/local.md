...
_See code: [src/commands/local/index.ts](https://github.com/heroku/cli/blob/v8.4.0-beta.0/src/commands/local/index.ts)_
...
_See code: [src/commands/local/run.ts](https://github.com/heroku/cli/blob/v8.4.0-beta.0/src/commands/local/run.ts)_
...
_See code: [src/commands/local/version.ts](https://github.com/heroku/cli/blob/v8.4.0-beta.0/src/commands/local/version.ts)_
