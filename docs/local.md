...
_See code: [src/commands/local/index.ts](https://github.com/heroku/cli/blob/v9.5.0/packages/cli/src/commands/local/index.ts)_
...
_See code: [src/commands/local/run.ts](https://github.com/heroku/cli/blob/v9.5.0/packages/cli/src/commands/local/run.ts)_
...
_See code: [src/commands/local/version.ts](https://github.com/heroku/cli/blob/v9.5.0/packages/cli/src/commands/local/version.ts)_
