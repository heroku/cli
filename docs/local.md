...
_See code: [src/commands/local/index.ts](https://github.com/heroku/cli/blob/v8.3.2-beta.7/src/commands/local/index.ts)_
...
_See code: [src/commands/local/run.ts](https://github.com/heroku/cli/blob/v8.3.2-beta.7/src/commands/local/run.ts)_
...
_See code: [src/commands/local/version.ts](https://github.com/heroku/cli/blob/v8.3.2-beta.7/src/commands/local/version.ts)_
