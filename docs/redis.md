...
_See code: [src/commands/redis/cli.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/cli.ts)_
...
_See code: [src/commands/redis/credentials.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/credentials.ts)_
...
_See code: [src/commands/redis/info.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/info.ts)_
...
_See code: [src/commands/redis/keyspace-notifications.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/keyspace-notifications.ts)_
...
_See code: [src/commands/redis/maxmemory.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/maxmemory.ts)_
...
```
USAGE
  $ heroku redis:promote [DATABASE] -a <value> [--prompt] [--as <value>] [-r <value>]
...
FLAGS
  -a, --app=<value>     (required) [default: app2-mm-test, env: HEROKU_APP] app to run command against
  -r, --remote=<value>  git remote of app to use
      --as=<value>      name for the Key-Value Store attachment
...
_See code: [src/commands/redis/promote.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/promote.ts)_
...
_See code: [src/commands/redis/stats-reset.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/stats-reset.ts)_
...
_See code: [src/commands/redis/timeout.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/timeout.ts)_
...
_See code: [src/commands/redis/upgrade.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/upgrade.ts)_
...
_See code: [src/commands/redis/wait.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/redis/wait.ts)_
