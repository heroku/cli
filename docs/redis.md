...
```
USAGE
  $ heroku redis [DATABASE] -a <value> [-j] [-r <value>]
...
_See code: [src/commands/redis/cli.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/cli.ts)_
...
_See code: [src/commands/redis/credentials.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/credentials.ts)_
...
```
USAGE
  $ heroku redis:info [DATABASE] -a <value> [-j] [-r <value>]
...
_See code: [src/commands/redis/info.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/info.ts)_
...
_See code: [src/commands/redis/keyspace-notifications.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/keyspace-notifications.ts)_
...
```
USAGE
  $ heroku redis:maintenance [DATABASE] -a <value> [-f] [-r <value>] [--run] [-w <value>]
...
_See code: [src/commands/redis/maintenance.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/maintenance.ts)_
...
_See code: [src/commands/redis/maxmemory.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/maxmemory.ts)_
...
_See code: [src/commands/redis/promote.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/promote.ts)_
...
_See code: [src/commands/redis/stats-reset.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/stats-reset.ts)_
...
_See code: [src/commands/redis/timeout.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/timeout.ts)_
...
```
USAGE
  $ heroku redis:upgrade [DATABASE] -a <value> -v <value> [-c <value>] [-r <value>]
...
_See code: [src/commands/redis/upgrade.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/upgrade.ts)_
...
```
USAGE
  $ heroku redis:wait [DATABASE] -a <value> [-r <value>] [--wait-interval <value>]
...
_See code: [src/commands/redis/wait.ts](https://github.com/heroku/cli/blob/v11.0.0-alpha.29/src/commands/redis/wait.ts)_
