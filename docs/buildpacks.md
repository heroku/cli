...
_See code: [src/commands/buildpacks/index.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/index.ts)_
...
```
USAGE
  $ heroku buildpacks:add BUILDPACK -a <value> [--prompt] [-i <value>] [-j] [-r <value>]
...
_See code: [src/commands/buildpacks/add.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/add.ts)_
...
_See code: [src/commands/buildpacks/clear.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/clear.ts)_
...
```
USAGE
  $ heroku buildpacks:info BUILDPACK [--prompt] [-j]
...
_See code: [src/commands/buildpacks/info.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/info.ts)_
...
```
USAGE
  $ heroku buildpacks:remove [BUILDPACK] -a <value> [--prompt] [-i <value>] [-j] [-r <value>]
...
_See code: [src/commands/buildpacks/remove.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/remove.ts)_
...
```
USAGE
  $ heroku buildpacks:search [TERM] [--prompt] [--description <value>] [--name <value>] [--namespace <value>]
...
_See code: [src/commands/buildpacks/search.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/search.ts)_

## `heroku buildpacks:set BUILDPACK`

```
USAGE
  $ heroku buildpacks:set BUILDPACK -a <value> [--prompt] [-i <value>] [-j] [-r <value>]
...
_See code: [src/commands/buildpacks/set.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/set.ts)_
...
_See code: [src/commands/buildpacks/versions.ts](https://github.com/heroku/cli/blob/v11.10.1-beta.0/src/commands/buildpacks/versions.ts)_
