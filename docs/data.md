...
* [`heroku data:pg:upgrade:run DATABASE`](#heroku-datapgupgraderun-database)
* [`heroku data:pg:upgrade:wait DATABASE`](#heroku-datapgupgradewait-database)
...
FLAGS
  -a, --app=<value>      (required) [default: app2-mm-test, env: HEROKU_APP] app to list addon maintenances for
...
_See code: [src/commands/data/maintenances/index.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/index.ts)_
...
FLAGS
  -a, --app=<value>      [default: app2-mm-test, env: HEROKU_APP] app to run command against
  -c, --csv              output in csv format
...
_See code: [src/commands/data/maintenances/history.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/history.ts)_
...
FLAGS
  -a, --app=<value>     [default: app2-mm-test, env: HEROKU_APP] app to list addon maintenances for
  -j, --json            output result in json
  -r, --remote=<value>  git remote of app to use
...
_See code: [src/commands/data/maintenances/info.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/info.ts)_
...
FLAGS
  -a, --app=<value>      [default: app2-mm-test, env: HEROKU_APP] app to run addon maintenance for
...
_See code: [src/commands/data/maintenances/run.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/run.ts)_
...
_See code: [src/commands/data/maintenances/schedule.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/schedule.ts)_
...
_See code: [src/commands/data/maintenances/wait.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/wait.ts)_
...
FLAGS
  -a, --app=<value>     [default: app2-mm-test, env: HEROKU_APP] app to show addon maintenance window for
  -j, --json            output result in json
  -r, --remote=<value>  git remote of app to use
...
_See code: [src/commands/data/maintenances/window/index.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/window/index.ts)_
...
FLAGS
  -a, --app=<value>     [default: app2-mm-test, env: HEROKU_APP] app to update addon maintenance window for
  -j, --json            output result in json
  -r, --remote=<value>  git remote of app to use
...
_See code: [src/commands/data/maintenances/window/update.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/maintenances/window/update.ts)_
...
_See code: [src/commands/data/pg/attachments/index.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/attachments/index.ts)_
...
_See code: [src/commands/data/pg/attachments/create.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/attachments/create.ts)_
...
_See code: [src/commands/data/pg/attachments/destroy.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/attachments/destroy.ts)_
...
_See code: [src/commands/data/pg/create.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/create.ts)_
...
_See code: [src/commands/data/pg/credentials/index.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/credentials/index.ts)_
...
_See code: [src/commands/data/pg/credentials/create.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/credentials/create.ts)_
...
_See code: [src/commands/data/pg/credentials/destroy.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/credentials/destroy.ts)_
...
_See code: [src/commands/data/pg/credentials/rotate.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/credentials/rotate.ts)_
...
_See code: [src/commands/data/pg/credentials/url.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/credentials/url.ts)_
...
_See code: [src/commands/data/pg/destroy.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/destroy.ts)_
...
_See code: [src/commands/data/pg/docs.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/docs.ts)_
...
_See code: [src/commands/data/pg/fork.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/fork.ts)_
...
_See code: [src/commands/data/pg/info.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/info.ts)_
...
_See code: [src/commands/data/pg/levels.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/levels.ts)_
...
_See code: [src/commands/data/pg/migrate.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/migrate.ts)_
...
```
USAGE
  $ heroku data:pg:psql DATABASE -a <value> [--prompt] [-c <value>] [-f <value>] [-r <value>]
...
_See code: [src/commands/data/pg/psql.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/psql.ts)_
...
_See code: [src/commands/data/pg/quotas/index.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/quotas/index.ts)_
...
_See code: [src/commands/data/pg/quotas/update.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/quotas/update.ts)_
...
_See code: [src/commands/data/pg/settings.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/settings.ts)_
...
_See code: [src/commands/data/pg/update.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/update.ts)_

## `heroku data:pg:upgrade:run DATABASE`

upgrade the Postgres version on a Postgres Advanced database

```
USAGE
  $ heroku data:pg:upgrade:run DATABASE -a <value> [--prompt] [-c <value>] [-r <value>] [-v <value>]
...
_See code: [src/commands/data/pg/upgrade/run.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/upgrade/run.ts)_

## `heroku data:pg:upgrade:wait DATABASE`

shows status of an upgrade until it's complete

```
USAGE
  $ heroku data:pg:upgrade:wait DATABASE -a <value> [--no-notify] [-r <value>] [--wait-interval <value>]
...
EXAMPLES
  # Wait for upgrade to complete
    ...
    $ heroku data:pg:upgrade:wait DATABASE --app myapp
...
_See code: [src/commands/data/pg/upgrade/wait.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/upgrade/wait.ts)_
...
_See code: [src/commands/data/pg/wait.ts](https://github.com/heroku/cli/blob/v12.0.0-alpha.0/src/commands/data/pg/wait.ts)_
