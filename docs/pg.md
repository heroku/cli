...
* [`heroku pg:cache-hit [DATABASE]`](#heroku-pgcache-hit-database)
* [`heroku pg:calls [DATABASE]`](#heroku-pgcalls-database)
...
* [`heroku pg:extensions [DATABASE]`](#heroku-pgextensions-database)
* [`heroku pg:fdwsql PREFIX [DATABASE]`](#heroku-pgfdwsql-prefix-database)
* [`heroku pg:index-size [DATABASE]`](#heroku-pgindex-size-database)
* [`heroku pg:index-usage [DATABASE]`](#heroku-pgindex-usage-database)
...
* [`heroku pg:long-running-queries [DATABASE]`](#heroku-pglong-running-queries-database)
* [`heroku pg:mandelbrot [DATABASE]`](#heroku-pgmandelbrot-database)
...
* [`heroku pg:records-rank [DATABASE]`](#heroku-pgrecords-rank-database)
* [`heroku pg:reset [DATABASE]`](#heroku-pgreset-database)
* [`heroku pg:seq-scans [DATABASE]`](#heroku-pgseq-scans-database)
...
* [`heroku pg:stats-reset [DATABASE]`](#heroku-pgstats-reset-database)
* [`heroku pg:table_size [DATABASE]`](#heroku-pgtable_size-database)
* [`heroku pg:table-indexes-size [DATABASE]`](#heroku-pgtable-indexes-size-database)
* [`heroku pg:table-size [DATABASE]`](#heroku-pgtable-size-database)
* [`heroku pg:total_table_size [DATABASE]`](#heroku-pgtotal_table_size-database)
* [`heroku pg:total-index-size [DATABASE]`](#heroku-pgtotal-index-size-database)
* [`heroku pg:total-table-size [DATABASE]`](#heroku-pgtotal-table-size-database)
* [`heroku pg:unfollow DATABASE`](#heroku-pgunfollow-database)
* [`heroku pg:unused_indexes [DATABASE]`](#heroku-pgunused_indexes-database)
* [`heroku pg:unused-indexes [DATABASE]`](#heroku-pgunused-indexes-database)
...
* [`heroku pg:user-connections [DATABASE]`](#heroku-pguser-connections-database)
...
_See code: [src/commands/pg/backups/index.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/index.ts)_
...
_See code: [src/commands/pg/backups/cancel.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/cancel.ts)_
...
_See code: [src/commands/pg/backups/capture.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/capture.ts)_
...
_See code: [src/commands/pg/backups/delete.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/delete.ts)_
...
_See code: [src/commands/pg/backups/download.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/download.ts)_
...
_See code: [src/commands/pg/backups/info.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/info.ts)_
...
_See code: [src/commands/pg/backups/restore.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/restore.ts)_
...
_See code: [src/commands/pg/backups/schedule.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/schedule.ts)_
...
_See code: [src/commands/pg/backups/schedules.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/schedules.ts)_
...
_See code: [src/commands/pg/backups/unschedule.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/unschedule.ts)_
...
_See code: [src/commands/pg/backups/url.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/backups/url.ts)_
...
_See code: [src/commands/pg/bloat.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/bloat.ts)_
...
_See code: [src/commands/pg/blocking.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/blocking.ts)_
...
```
USAGE
  $ heroku pg:cache-hit [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/cache-hit.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/cache-hit.ts)_

## `heroku pg:calls [DATABASE]`

show 10 queries that have highest frequency of execution

```
USAGE
  $ heroku pg:calls [DATABASE] -a <value> [--prompt] [-r <value>] [-t]
...
_See code: [src/commands/pg/calls.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/calls.ts)_
...
_See code: [src/commands/pg/connection-pooling/attach.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/connection-pooling/attach.ts)_
...
_See code: [src/commands/pg/copy.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/copy.ts)_
...
_See code: [src/commands/pg/credentials.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/credentials.ts)_
...
_See code: [src/commands/pg/credentials/create.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/credentials/create.ts)_
...
_See code: [src/commands/pg/credentials/destroy.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/credentials/destroy.ts)_
...
_See code: [src/commands/pg/credentials/repair-default.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/credentials/repair-default.ts)_
...
_See code: [src/commands/pg/credentials/rotate.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/credentials/rotate.ts)_
...
_See code: [src/commands/pg/credentials/url.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/credentials/url.ts)_
...
_See code: [src/commands/pg/diagnose.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/diagnose.ts)_
...
```
USAGE
  $ heroku pg:extensions [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/extensions.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/extensions.ts)_
...
```
USAGE
  $ heroku pg:fdwsql PREFIX [DATABASE] -a <value> [--prompt] [-r <value>]

ARGUMENTS
  PREFIX      prefix for foreign data wrapper
  [DATABASE]  config var containing the connection string, unique name, ID, or alias of the database. To access another
              app's database, prepend the app name to the config var or alias with `APP_NAME::` . If omitted, we use
              DATABASE_URL.
...
_See code: [src/commands/pg/fdwsql.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/fdwsql.ts)_
...
```
USAGE
  $ heroku pg:index-size [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/index-size.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/index-size.ts)_
...
```
USAGE
  $ heroku pg:index-usage [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/index-usage.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/index-usage.ts)_
...
_See code: [src/commands/pg/info.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/info.ts)_
...
_See code: [src/commands/pg/kill.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/kill.ts)_
...
_See code: [src/commands/pg/killall.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/killall.ts)_
...
_See code: [src/commands/pg/links/index.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/links/index.ts)_
...
_See code: [src/commands/pg/links/create.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/links/create.ts)_
...
_See code: [src/commands/pg/links/destroy.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/links/destroy.ts)_
...
```
USAGE
  $ heroku pg:locks [DATABASE] -a <value> [--prompt] [-r <value>] [-t]
...
_See code: [src/commands/pg/locks.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/locks.ts)_
...
```
USAGE
  $ heroku pg:long-running-queries [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/long-running-queries.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/long-running-queries.ts)_
...
```
USAGE
  $ heroku pg:mandelbrot [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/mandelbrot.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/mandelbrot.ts)_
...
```
USAGE
  $ heroku pg:outliers [DATABASE] -a <value> [--prompt] [-n <value>] [-r <value>] [--reset] [-t]
...
_See code: [src/commands/pg/outliers.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/outliers.ts)_
...
_See code: [src/commands/pg/promote.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/promote.ts)_
...
```
USAGE
  $ heroku pg:ps [DATABASE] -a <value> [--prompt] [-r <value>] [-v]
...
_See code: [src/commands/pg/ps.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/ps.ts)_
...
```
USAGE
  $ heroku pg:psql [DATABASE] -a <value> [--prompt] [-c <value>] [--credential <value>] [-f <value>] [-r
    <value>]
...
_See code: [src/commands/pg/psql.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/psql.ts)_
...
_See code: [src/commands/pg/pull.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/pull.ts)_
...
_See code: [src/commands/pg/push.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/push.ts)_
...
```
USAGE
  $ heroku pg:records-rank [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/records-rank.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/records-rank.ts)_
...
_See code: [src/commands/pg/reset.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/reset.ts)_
...
```
USAGE
  $ heroku pg:seq-scans [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/seq-scans.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/seq-scans.ts)_
...
_See code: [src/commands/pg/settings/index.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/index.ts)_
...
_See code: [src/commands/pg/settings/auto-explain.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-analyze.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-analyze.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-buffers.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-buffers.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-format.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-format.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-min-duration.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-min-duration.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-nested-statements.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-nested-statements.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-triggers.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-triggers.ts)_
...
_See code: [src/commands/pg/settings/auto-explain/log-verbose.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/auto-explain/log-verbose.ts)_
...
_See code: [src/commands/pg/settings/data-connector-details-logs.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/data-connector-details-logs.ts)_
...
_See code: [src/commands/pg/settings/log-connections.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/log-connections.ts)_
...
_See code: [src/commands/pg/settings/log-lock-waits.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/log-lock-waits.ts)_
...
_See code: [src/commands/pg/settings/log-min-duration-statement.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/log-min-duration-statement.ts)_
...
_See code: [src/commands/pg/settings/log-min-error-statement.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/log-min-error-statement.ts)_
...
_See code: [src/commands/pg/settings/log-statement.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/log-statement.ts)_
...
_See code: [src/commands/pg/settings/track-functions.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/settings/track-functions.ts)_
...
```
USAGE
  $ heroku pg:stats-reset [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/stats-reset.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/stats-reset.ts)_
...
```
USAGE
  $ heroku pg:table_size [DATABASE] -a <value> [--prompt] [-r <value>]
...
## `heroku pg:table-indexes-size [DATABASE]`

show the total size of all the indexes on each table, descending by size

```
USAGE
  $ heroku pg:table-indexes-size [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/table-indexes-size.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/table-indexes-size.ts)_
...
```
USAGE
  $ heroku pg:table-size [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/table-size.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/table-size.ts)_
...
```
USAGE
  $ heroku pg:total_table_size [DATABASE] -a <value> [--prompt] [-r <value>]
...
## `heroku pg:total-index-size [DATABASE]`

show the total size of all indexes in MB

```
USAGE
  $ heroku pg:total-index-size [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/total-index-size.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/total-index-size.ts)_
...
```
USAGE
  $ heroku pg:total-table-size [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/total-table-size.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/total-table-size.ts)_
...
_See code: [src/commands/pg/unfollow.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/unfollow.ts)_
...
```
USAGE
  $ heroku pg:unused_indexes [DATABASE] -a <value> [--prompt] [-r <value>]
...
## `heroku pg:unused-indexes [DATABASE]`

show unused and almost unused indexes

```
USAGE
  $ heroku pg:unused-indexes [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/unused-indexes.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/unused-indexes.ts)_
...
_See code: [src/commands/pg/upgrade/cancel.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/upgrade/cancel.ts)_
...
_See code: [src/commands/pg/upgrade/dryrun.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/upgrade/dryrun.ts)_
...
_See code: [src/commands/pg/upgrade/prepare.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/upgrade/prepare.ts)_
...
_See code: [src/commands/pg/upgrade/run.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/upgrade/run.ts)_
...
_See code: [src/commands/pg/upgrade/wait.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/upgrade/wait.ts)_

## `heroku pg:user-connections [DATABASE]`

returns the number of connections per credential

```
USAGE
  $ heroku pg:user-connections [DATABASE] -a <value> [--prompt] [-r <value>]
...
_See code: [src/commands/pg/user-connections.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/user-connections.ts)_
...
_See code: [src/commands/pg/vacuum-stats.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/vacuum-stats.ts)_
...
```
USAGE
  $ heroku pg:wait [DATABASE] -a <value> [--prompt] [--no-notify] [-r <value>] [--wait-interval <value>]
...
_See code: [src/commands/pg/wait.ts](https://github.com/heroku/cli/blob/v11.8.0-alpha.1/src/commands/pg/wait.ts)_
