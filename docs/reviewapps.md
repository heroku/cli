...
_See code: [@heroku-cli/plugin-pipelines](https://github.com/heroku/cli/blob/v7.42.8/src/commands/reviewapps/disable.ts)_
...
_See code: [@heroku-cli/plugin-pipelines](https://github.com/heroku/cli/blob/v7.42.8/src/commands/reviewapps/enable.ts)_
