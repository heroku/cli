...
FLAGS
  -a, --app=<value>       [default: heroku-vscode] parent app used by review apps
...
_See code: [src/commands/reviewapps/disable.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.0/packages/cli/src/commands/reviewapps/disable.ts)_
...
_See code: [src/commands/reviewapps/enable.ts](https://github.com/heroku/cli/blob/v10.0.3-alpha.0/packages/cli/src/commands/reviewapps/enable.ts)_
