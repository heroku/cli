...
_See code: [@heroku-cli/plugin-ps](https://github.com/heroku/cli/blob/v7.18.6/packages/ps/src/commands/ps/autoscale/disable.ts)_
...
_See code: [@heroku-cli/plugin-ps](https://github.com/heroku/cli/blob/v7.18.6/packages/ps/src/commands/ps/autoscale/enable.ts)_
