...
_See code: [src/commands/releases/index.ts](https://github.com/heroku/cli/blob/v9.1.0/packages/cli/src/commands/releases/index.ts)_
...
_See code: [src/commands/releases/info.ts](https://github.com/heroku/cli/blob/v9.1.0/packages/cli/src/commands/releases/info.ts)_
...
_See code: [src/commands/releases/output.ts](https://github.com/heroku/cli/blob/v9.1.0/packages/cli/src/commands/releases/output.ts)_
...
_See code: [src/commands/releases/rollback.ts](https://github.com/heroku/cli/blob/v9.1.0/packages/cli/src/commands/releases/rollback.ts)_
