...
// NOTE: This module depends on 'mustache' which is not a CLI dependency.
// The `nf export` command is not used by any Heroku CLI command, so this
// dependency is never exercised at runtime.
...
var display = require('./console.cjs').Console;
