...
`,
    `$ heroku-cli hello --name myname
hello myname from hello!
`,
    '$ heroku-cli hello file outputs "hello world!" to file',
    '$ heroku-cli hello --force',
    '$ heroku-cli hello --help',
  ]

  // allow running this command by running `$ heroku-cli foobar`
