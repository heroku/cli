...
describe('psql private-network tiers', function () {
  ...
  describe('advanced-private tier', function () {
    beforeEach(function () {
      setup('heroku-postgresql:advanced-private')
    })
  ...
  describe('classic shield tier', function () {
    beforeEach(function () {
      setup('heroku-postgresql:shield-0')
    })
  ...
  describe('classic private tier (bastion)', function () {
    beforeEach(function () {
      setup('heroku-postgresql:private-0')
    })
